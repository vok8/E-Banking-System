...
public class FindAccount extends JInternalFrame implements ActionListener 
{
	...
	private JLabel ac_number_label, name_label, date_label, balance_label;
	private JTextField ac_number_tf, name_tf, date_tf, balance_tf;
	...
	FindAccount() 
	{
		...
		balance_label.setBounds(15, 125, 110, 25);
		...
		balance_tf.setHorizontalAlignment(JTextField.RIGHT);
		balance_tf.setEnabled(false);
		balance_tf.setBounds(125, 125, 200, 25);
		...
		jp_find.add(date_tf);
		jp_find.add(balance_label);
		jp_find.add(balance_tf);
	...
	public void actionPerformed(ActionEvent ae) 
	{
		...
		if(obj==find_button) 
		{
			...
			{
				JOptionPane.showMessageDialog(this, "Please! Provide Acc. No. of Customer to Search.", "Bank System - Empty Field", JOptionPane.PLAIN_MESSAGE);
	...
	void findRec() 
	{
		...
		if(found==false) 
		{
			JOptionPane.showMessageDialog (this, "Account No. " + ac_number_tf.getText () + " doesn't Exist!", "Bank System - Wrong Acc. No.", JOptionPane.PLAIN_MESSAGE);
			txtClear();
		}
	}
	...
	public void showRec(int rr) 
	{
		...
		balance_tf.setText(records[rr][5]);
	}
